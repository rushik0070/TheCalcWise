...
export default function Emi() {
    ...
    const [Initial, SetInitial] = useState(5000); // monthly for SIP
    const [FinalAmount, SetFinalAmount] = useState(25000); // annual %
    const [time, setTime] = useState(5); 

    const months = time * 12;

    const Cagr = ((Math.pow(FinalAmount / Initial, 1 / time) - 1) * 100).toFixed(2);
    console.log("cagr is ",Cagr)
    ...
    // console.log(Cagr)
    // const CagerInWords = toWords.convert(Cagr);
    // console.log(CagerInWords)
            ...
            <div className='row mt-5'>
                ...
                <div className='col-md-7'>
                    <div className="calc-container">
                        ...
                        <div className='row'>
                            <div className='col-6'>
                                <h4 className="fw-bold mb-4">CAGR Calculator
                                </h4>
                            </div>
                        </div>
                            ...
                            <div className="card-body shadow p-4">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        {/* Return Rate */}
                                        <div className="mb-3">
                                            <label className="form-label fw-bold">Final Investment</label>
                                        ...
                                        {/* Time Period */}
                                        <div className="mb-3">
                                            <label className="form-label fw-bold">Duration Of Investment</label>
                                            <input
                                                type="range"
                                                className="form-range"
                                                min="1"
                                ...
                                <div className='row mt-2'>
                                    <div className='col-md-12'>
                                        <strong>Your CAGR is : {Cagr.toLocaleString(undefined, { maximumFractionDigits: 2 })} %</strong>
                                    </div>
                                </div>
