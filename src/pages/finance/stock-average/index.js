                            ...
                            <div className="card-body">
                                ...
                                {purchases.map((purchase, index) => (
                                    <div className="mb-4" key={index}>
                                        <label className="form-label fw-bold">{`Purchase ${index + 1}`}</label>
                                        <div className="row g-3">
                                            ...
                                            <div className="col">
                                                <div className="input-group">
                                                    <span className="input-group-text currency text-success fw-bold">Units</span>
                                ...
                                <div className="results p-3 rounded">
                                    <div className="d-flex justify-content-between mb-2 fw-bold">
                                        ...
                                        <strong className="text-success">₹ {averagePrice.toFixed(2)}</strong>
                                    </div>
                                    <div className="d-flex justify-content-between mb-2 fw-bold">
                                        <strong>Total quantity</strong>
                                        <strong className="text-success">{totalQuantity}</strong>
                                    </div>
